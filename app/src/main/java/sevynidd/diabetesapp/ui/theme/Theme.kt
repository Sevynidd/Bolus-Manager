...
fun DiabetesAppTheme(
    ...
    val colorScheme = when {
        ...
        darkTheme -> when (contrastLevel) {
            ...
            ContrastLevel.MediumContrast -> mediumContrastDarkColorScheme
            ContrastLevel.HighContrast -> highContrastDarkColorScheme
        }

        else -> when (contrastLevel) {
            ContrastLevel.Normal -> lightScheme
            ContrastLevel.MediumContrast -> mediumContrastLightColorScheme
            ContrastLevel.HighContrast -> highContrastLightColorScheme
        }
    }
